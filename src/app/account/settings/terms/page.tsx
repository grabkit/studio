            ...
            >
                <div className="h-full overflow-y-auto">
                    <div className="p-4 space-y-4 prose prose-sm dark:prose-invert max-w-none">
                        ...
                        <p>If you have any questions about these Terms of Service, you can contact us at <a href="mailto:blur.workspace@gmail.com" className="text-primary hover:underline">blur.workspace@gmail.com</a>.</p>
                    </div>
                </div>
            </motion.div>
        </AppLayout>
