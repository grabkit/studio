  ...
  return (
    ...
    >
      ...
      <div className="relative w-[320px] h-[320px] flex items-center justify-center mb-16">
            ...
            {/* Avatars */}
            <div className="absolute top-1/2 left-1/2 h-12 w-12 animate-rotate-outer-1">
             ...
             <div className="absolute top-1/2 left-1/2 h-12 w-12 animate-rotate-outer-2">
                <div className="relative h-full w-full rounded-full overflow-hidden blur-[2px]">
                    <Image
            ...
            <div className="absolute top-1/2 left-1/2 h-10 w-10 animate-rotate-inner-1">
                <div className="relative h-full w-full rounded-full overflow-hidden blur-[2px]">
                    <Image
             ...
             <div className="absolute top-1/2 left-1/2 h-10 w-10 animate-rotate-inner-2">
                <div className="relative h-full w-full rounded-full overflow-hidden blur-[2px]">
                    <Image
