  ...
  return (
    ...
    >
      ...
      <div className="relative w-[320px] h-[320px] flex items-center justify-center mb-16">
            ...
            {/* Avatars */}
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2" style={{ transform: 'translate(-50%, -50%) translateY(-150px)' }}>
            ...
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2" style={{ transform: 'translate(-50%, -50%) translateX(-100px)' }}>
